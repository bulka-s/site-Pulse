...
function Feedback() {
    ...
    const [animStage, setAnimStage] = useState<string>(""); // "out" | "in" | ""
    ...
    const handleChange = (index: number, dir: string = "next") => {
    ...
    const handlePrev = () => {
        const index = (currentSlide - 1 + feedbackData.length) % feedbackData.length;
        ...
        <div id="feedback" className="feedback">
            ...
            <div className="feedback-slider">
                <div className="feedback-card">
                    ...
                    <div
                        className={`feedback-content ${animStage ? animStage : ""} ${direction}`}
                    >
